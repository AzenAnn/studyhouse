...
% TEST_CHECKBOX MATLAB code for test_checkbox.fig
...
%      applied to the GUI before test_checkbox_OpeningFcn gets called.  An
...
% Last Modified by GUIDE v2.5 28-Sep-2014 11:19:20
...
% Place the corect value into the text field
if state == 0
   string = 'Off';
else
   string = 'On';
